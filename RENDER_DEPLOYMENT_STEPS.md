...
### 3. Project (Optional)
- **Action:** You can skip this for now, or click "+ Create a project" if you want to organize
...
- **Action:**
  ...
  2. Delete `$ yarn`
  3. Type: `npm install`
  4. (Or use: `cd backend && npm install` if Root Directory doesn't work)
...
- **Action:**
  ...
  2. Delete `$ yarn start`
  3. Type: `npm start`
  4. (Or use: `cd backend && npm start` if Root Directory doesn't work)
...
1. **Get your URL:**
   - At the top of the page, you'll see: `https://testing-deploy.onrender.com` (or similar)
